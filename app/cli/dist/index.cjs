...
var isManualContinue = async (message = "\u662F\u5426\u7EE7\u7EED\uFF1F") => {
  const { goOn: continueMerge } = await import_inquirer.default.prompt([
    {
      type: "confirm",
      name: "goOn",
      message,
...
async function mergeMarkdown() {
  inputPath = await generate_manual_continue(async () => {
    const { filepath } = await import_inquirer2.default.prompt([
      {
        type: "input",
        name: "filepath",
  ...
  outputPath = await generate_manual_continue(async () => {
    const { output } = await import_inquirer2.default.prompt([
      {
        type: "input",
        name: "output",
...
console.log(
  import_chalk.default.yellow("\u5DE5\u5177\u8BF4\u660E\uFF1A") + "\n" + import_chalk.default.cyan("1. \u5408\u5E76 Markdown \u6587\u4EF6\uFF1A") + import_chalk.default.gray("\u5C06\u591A\u4E2A Markdown \u6587\u4EF6\u5408\u5E76\u4E3A\u4E00\u4E2A\u3002") + "\n" + import_chalk.default.cyan("2. \u5DE5\u51772\uFF1A") + import_chalk.default.gray("\u8FD9\u91CC\u662F\u5DE5\u51772\u7684\u529F\u80FD\u63CF\u8FF0\u3002") + "\n" + import_chalk.default.cyan("3. \u9000\u51FA\uFF1A") + import_chalk.default.gray("\u9000\u51FA\u7A0B\u5E8F\u3002") + "\n"
);
program.name("md-merge").description("\u5408\u5E76\u591A\u4E2A Markdown \u6587\u4EF6").version("1.0.0");
program.action(async () => {
  const { tool } = await import_inquirer3.default.prompt([
    {
      type: "list",
      name: "tool",
      message: "\u8BF7\u9009\u62E9\u8981\u4F7F\u7528\u7684\u5DE5\u5177\uFF1A",
